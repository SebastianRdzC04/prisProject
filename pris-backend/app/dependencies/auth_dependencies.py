...
from .user_dependencies import get_user_repository, get_personal_data_repository
...
def get_auth_service(user_repository: UserRepository = Depends(get_user_repository),
                     ...
                     personal_data_repository:PersonalDataRepository = Depends(get_personal_data_repository),
                     admin_repository:AdminRepository = Depends(get_admin_repository)) -> AuthService:
    """
    Dependency to get the AuthService instance.
    """
    return AuthService(user_repository, client_repository, personal_data_repository, admin_repository)